...
if(LJ_64 AND NOT LUAJIT_ENABLE_GC64 AND ("${LJ_TARGET_ARCH}" STREQUAL "x64"))
  set(LJ_GC64 0)
endif()
...
if(LUAJIT_ENABLE_GC64)
  set(LJ_DEFINITIONS ${LJ_DEFINITIONS} -DLUAJIT_ENABLE_GC64)
  set(TARGET_ARCH ${TARGET_ARCH} -DLUAJIT_ENABLE_GC64)
endif()
